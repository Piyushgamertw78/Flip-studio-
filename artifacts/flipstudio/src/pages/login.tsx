      ...
      <div className="page-enter-up min-h-screen bg-[#060610] flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div className="relative w-full max-w-sm z-10 fade-in-scale">
          ...
          <div className="glass-panel rounded-3xl p-6">
            ...
            <button onClick={() => SUPABASE_ENABLED ? void loginWithGoogle() : setShowGooglePicker(true)}
              className="w-full h-12 mb-3 rounded-xl font-semibold text-sm flex items-center justify-center gap-3 border border-white/15 bg-white/8 hover:bg-white/12 active:scale-[0.97] transition-all text-white/90 press">
